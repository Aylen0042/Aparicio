<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="carga_refrigerante.aspx.cs" Inherits="aparicio.com.ar.Páginas.Servicios.carga_gas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container marketing mt-3 w-75">
        <div class="card border-primary">
            <div class="card-header border-primary bg-primary">
                <strong class="text-bg-primary">CARGA DE REFRIGERANTE</strong>
            </div>
            <div class="card-body">
                <p class="card-text">
                    Carga de refrigerante de equipos de aire acondicionado en viviendas, comercios, talleres, industriales, cámaras frigoríficas.
                    Es fundamental encontrar la pérdida por donde se ha fugado el gas, antes de realizar la carga.</p>
            </div>
        </div>
    </div>
    ...
    <div style="display:flex; justify-content:center; align-content:center; margin: 3.25rem;">
        ...
        <div class="card border-primary">
            ...
            <img class="card-img-top h-50 p-5" src="/Img/Servicios/carga_refrigerante_split.jpg" />
            <div class="card-body">
        ...
        <div class="card border-primary">
            <img class="card-img-top h-50 p-5" src="/Img/Servicios/carga_refrigerante_Automotriz.jpg" />
            <div class="card-body">
        ...
        <div class="card border-primary">
            <img class="card-img-top h-50 p-5" src="/Img/Servicios/carga_refrigerante_heladera.jpg" />
            <div class="card-body">
